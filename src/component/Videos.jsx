    ...
    <Stack  direction={["column", "row"]}  h={"100vh"}>
        <VStack w={"full"} >
            ...
            <VStack alignItems={"flex-start"} p={"8"} w={"full"} overflowY={"auto"}>
                        ...
                        <Heading> Sample {videosArr.length[0]} </Heading>
               
                <Text>this is video description Lorem ipsum dolor sit, amet consectetur adipisicing elit. Quisquam animi nisi cum fugit consequatur facere fugiat ad magni commodi ipsam deleniti molestiae suscipit provident nihil odit rerum, libero architecto nam. Lorem ipsum dolor, sit amet consectetur adipisicing elit. Ducimus aperiam nesciunt sunt eum, numquam explicabo quos molestias molestiae quam consequatur accusamus consectetur quae totam odio tempora nihil minus quis veniam neque et sapiente exercitationem delectus harum. </Text>
            </VStack>
        </VStack>
